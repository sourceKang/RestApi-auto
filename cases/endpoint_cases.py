...
READ_ENDPOINTS = [
    ...
    EndpointCase("port_by_slot", "GET", "inventory", lambda env: f"/port/{env.dut.device_name}/{env.dut.ge_slot_id or env.dut.slot_id}", case_id="EMS1-6683"),
    EndpointCase("port_by_id", "GET", "inventory", lambda env: f"/port/{env.dut.device_name}/{env.dut.ge_slot_id or env.dut.slot_id}/{env.dut.ge_port_id or env.dut.port_id}", case_id="EMS1-6684"),
