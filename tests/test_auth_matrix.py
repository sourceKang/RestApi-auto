...
def test_rad_external_readonly_summary(auth_matrix_service, rad_env_config, rad_readonly_session, rad_readwrite_session):
...
def test_rad_external_noaccess_summary(auth_matrix_service, rad_env_config, rad_noaccess_session, rad_readwrite_session):
