...
PAIRED_RETRY_CONFIG_FILE = Path(__file__).resolve().parents[1] / "configs" / "neox_ge_paired_retry_probe.json"
...
def test_ge_paired_retry_probe_collects_compound_cli_field_results(
    ...
    if not ssh_username or not ssh_password:
        pytest.skip("Set NEOX_SSH_USERNAME and NEOX_SSH_PASSWORD to run GE paired retry probe.")
