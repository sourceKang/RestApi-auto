...
def test_neox_qos_profile_minmax_create_and_cli_verify(
    api_client,
    env_config,
    neox_config_service,
    session_manager,
    ...
    report_path = write_qos_profile_report(neox_config_service, results)
    assert results, f"No QoS profile cases executed. Report: {report_path}"
