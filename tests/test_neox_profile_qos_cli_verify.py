...
from services.neox_config.service import PROFILE_QOS_MINMAX_CASES_FILE
...
QOS_MINMAX_CASES_FILE = PROFILE_QOS_MINMAX_CASES_FILE
...
def test_neox_qos_profile_minmax_create_readwrite(
    ...
    ssh_username, ssh_password = neox_cli_credentials(env_config, "QoS profile CLI verification")
